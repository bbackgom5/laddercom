...
.lst_type li a{color:#2d2c2d;text-decoration:none; margin-left:200px}
.lst_type li a:hover{text-decoration:underline}
.lst_type li span{color:blue; margin-left:150px;font-family:'돋움',Dotum;font-size:14px;  }
</style>
<meta charset="UTF-8">
		...
		<c:forEach var="i"  begin="1" end="9"  step="1">
			<li>
				<a href='#'   style='margin-left:10px'>
					<img src='../image/abc2.jpg'  width='90'  height='90'  alt='lulu'  /></a>
