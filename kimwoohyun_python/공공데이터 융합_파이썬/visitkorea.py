...
#대륙 분기 년  컬럼에서 소계라고 입력되어 있는 values 항목들 제거
...
ignore_list_3=['2010 소계','2011 소계','2012 소계','2013 소계','2014 소계','2015 소계','2016 소계','2017 소계','2018 소계','2019 소계','2020 소계']
...
for year in range(2010,2022):   #2021~2021 범위
    for number in range(1,241):     #범위 설정(각 년도별 240개씩의 데이터)
